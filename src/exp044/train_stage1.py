...
EXP_ID = "044"
COMMENT = """classification + normalize + heavy augmentations + cutout"""
...
class ContrailsLightningModel(pl.LightningModule):
    def __init__(
        self,
        model_name: str = "resnet34",
        pretrained: bool = False,
    ...
    def add_model_specific_args(
        ...
        parser = parent_parser.add_argument_group("ContrailsLightningModel")
        parser.add_argument(
            "--model_name",
            default="resnet34",
            type=str,
...
def get_args() -> argparse.Namespace:
    ...
    parser = ContrailsLightningModel.add_model_specific_args(parent_parser)
