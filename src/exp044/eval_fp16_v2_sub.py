...
"""
####### w/o postprocess ##########
resnetrs101_cls_stage1 + resnetrs101_unet_stage2_ep60 fold0: score: 0.6703729859935286 cls_score: 0.8521574415971619 seg_threshold: 0.9937988281250012 cls_threshold: 0.7109375000000006
swinv2_base_window16_cls_stage1 + swinv2_base_window16_unet_stage2_ep60 fold0: score: 0.6627902266881894 cls_score: 0.8474571263049959 seg_threshold: 0.9940429687500012 cls_threshold: 0.7250000000000005
convnext_base_cls_stage1 + convnext_base_unet_stage2_ep60 fold0: score: 0.6691213358980009 cls_score: 0.8440704606167864 seg_threshold: 0.9931640625000013 cls_threshold: 0.7203125000000006
swin_base_patch4_window12_cls_stage1 + swin_base_patch4_window12_unet_stage2_ep60 fold0: score: 0.6654054061481115 cls_score: 0.84530336598424 seg_threshold: 0.9936523437500012 cls_threshold: 0.7125000000000006
resnetrs50_cls_stage1 + resnetrs50_unet_stage2_ep60 fold0: score: 0.6696314756309341 cls_score: 0.8453405184591389 seg_threshold: 0.9933593750000013 cls_threshold: 0.7367187500000005

resnetrs50_cls_stage1_small + resnetrs50_unet_stage2_small_ep60 fold0: score: 0.6631230288306444 cls_score: 0.8481370356787085 seg_threshold: 0.9936523437500012 cls_threshold: 0.7332031250000005
####### w/o postprocess ##########
"""
...
def main(args):
    ...
    print(f"ckpt_path = {ckpt_path}")
    seg_model_stage1 = ContrailsLightningSegModel.load_from_checkpoint(
        ckpt_path, pretrained=False
    )
    model.eval()
