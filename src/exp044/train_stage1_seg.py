...
EXP_ID = "044"
COMMENT = """UNet Baseline without negative + normalize + w/o grid distortion + cutout + w/o flip, rotate"""
...
class ContrailsLightningSegModel(pl.LightningModule):
    def __init__(
        self,
        model_name: str = "resnet34",
        pretrained: bool = False,
    ...
    def add_model_specific_args(
        ...
        parser = parent_parser.add_argument_group("ContrailsLightningSegModel")
        parser.add_argument(
            "--model_name",
            default="resnet34",
            type=str,
...
def get_args() -> argparse.Namespace:
    ...
    parser = ContrailsLightningSegModel.add_model_specific_args(parent_parser)
...
def main(args):
    ...
    model = ContrailsLightningSegModel(
