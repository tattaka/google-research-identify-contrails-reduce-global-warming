...
EXP_ID = "052"
COMMENT = """
UNet Baseline without negative + normalize + w/o grid distortion + post_conv3d + seq_len option(default: 7) + low flip, rotate + reverse_video_aug + add upsampling(for swin, convnext)
"""
