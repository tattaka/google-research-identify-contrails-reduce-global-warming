...
python train_stage1.py --seed 9023 --model_name hrnet_w32.ms_in1k \
    --lr 1e-3 --batch_size 4 --image_size 512 \
    --fold 0 --gpus 4 --epochs 30 --logdir hrnet_w32_cls_stage1 --num_workers 6 --disable_compile

python train_stage2.py --seed 9024 --model_name hrnet_w32.ms_in1k --attention_type cbam \
    --lr 1e-3 --batch_size 4 --image_size 512 --decoder_type FastFCNImprove \
    --fold 0 --gpus 4 --epochs 60 --logdir hrnet_w32_fastfcn_cbam_stage2_ep60 --num_workers 6 --disable_compile

python train_stage1_seg.py --seed 9025 --model_name hrnet_w32.ms_in1k --attention_type cbam \
    --lr 1e-3 --batch_size 4 --image_size 512 --decoder_type FastFCNImprove \
    --fold 0 --gpus 4 --epochs 30 --logdir hrnet_w32_fastfcn_cbam_stage1_ep30 --num_workers 6 --disable_compile

python eval_fp16.py --batch_size 16  --fold 0 \
    --logdir_cls hrnet_w32cls_stage1 --logdir_seg hrnet_w32_fastfcn_cbam_stage2_ep60 --num_workers 6

python eval_fp16_v2.py --batch_size 16  --fold 0 --logdir_cls hrnet_w32_cls_stage1 \
    --logdir_seg hrnet_w32_fastfcn_cbam_stage2_ep60 --logdir_stage1_seg hrnet_w32_fastfcn_cbam_stage1_ep30 --num_workers 6

python eval_fp16_v2_sub.py --batch_size 16  --fold 0 --logdir_cls hrnet_w32_cls_stage1 \
    --logdir_seg hrnet_w32_fastfcn_cbam_stage2_ep60 --logdir_stage1_seg hrnet_w32_fastfcn_cbam_stage1_ep30 --num_workers 6


python train_stage1.py --seed 10024 --model_name cspdarknet53.ra_in1k	 \
    --lr 1e-3 --batch_size 4 --image_size 384 \
    --fold 0 --gpus 4 --epochs 30 --logdir cspdarknet53_cls_stage1_384 --num_workers 6 --disable_compile

python train_stage2.py --seed 10024 --model_name cspdarknet53.ra_in1k	 \
    --lr 1e-3 --batch_size 4 --image_size 384 --decoder_type FastFCNImprove \
    --fold 0 --gpus 4 --epochs 60 --logdir cspdarknet53_fastfcn_stage2_384_ep60 --num_workers 6  --disable_compile

python train_stage1_seg.py --seed 10025 --model_name cspdarknet53.ra_in1k	 \
    --lr 1e-3 --batch_size 4 --image_size 384 --decoder_type FastFCNImprove \
    --fold 0 --gpus 4 --epochs 30 --logdir cspdarknet53_fastfcn_stage1_384_ep30 --num_workers 6  --disable_compile

python eval_fp16.py --batch_size 16  --fold 0 \
    --logdir_cls cspdarknet53_cls_stage1_384 --logdir_seg cspdarknet53_fastfcn_stage2_384_ep60 --num_workers 6

python eval_fp16_v2.py --batch_size 16  --fold 0 \
    --logdir_cls cspdarknet53_cls_stage1_384 --logdir_seg cspdarknet53_fastfcn_stage2_384_ep60 --logdir_stage1_seg cspdarknet53_fastfcn_stage1_384_ep30 --num_workers 6
