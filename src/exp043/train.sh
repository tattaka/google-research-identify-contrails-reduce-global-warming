...
python train_stage2.py --seed 6024 --model_name convnext_base.fb_in1k --drop_path_rate 0.4 \
    --lr 1e-3 --batch_size 4 --image_size 256 \
    --fold 0 --gpus 4 --epochs 60 --logdir convnext_base_unet_stage2_ep60 --num_workers 6 --disable_compile

python train_stage1_seg.py --seed 6025 --model_name convnext_base.fb_in1k --drop_path_rate 0.4 \
    --lr 1e-3 --batch_size 4 --image_size 256 \
    --fold 0 --gpus 4 --epochs 30 --logdir convnext_base_unet_stage1_ep30 --num_workers 6 --disable_compile
...
python train_stage1.py --seed 7024 --model_name resnetrs50 --drop_path_rate 0.2 \
    --lr 1e-3 --batch_size 4 --image_size 512 \
    --fold 0 --gpus 4 --epochs 30 --logdir resnetrs50_cls_stage1_512 --num_workers 6 --disable_compile

python train_stage2.py --seed 7024 --model_name resnetrs50 --drop_path_rate 0.4 \
    --lr 1e-3 --batch_size 4 --image_size 512 \
    --fold 0 --gpus 4 --epochs 60 --logdir resnetrs50_unet_stage2_512_ep60 --num_workers 6  --disable_compile

python train_stage1_seg.py --seed 7025 --model_name resnetrs50 --drop_path_rate 0.4 \
    --lr 1e-3 --batch_size 4 --image_size 512 \
    --fold 0 --gpus 4 --epochs 30 --logdir resnetrs50_unet_stage1_512_ep30 --num_workers 6  --disable_compile

python eval_fp16.py --batch_size 16  --fold 0 \
    --logdir_cls resnetrs50_cls_stage1_512 --logdir_seg resnetrs50_unet_stage2_512_ep60 --num_workers 6

python eval_fp16_v2.py --batch_size 4  --fold 0 \
    --logdir_cls resnetrs50_cls_stage1_512 --logdir_seg resnetrs50_unet_stage2_512_ep60 --logdir_stage1_seg resnetrs50_unet_stage1_512_ep30 --num_workers 6
