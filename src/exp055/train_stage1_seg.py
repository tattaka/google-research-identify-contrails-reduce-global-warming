...
EXP_ID = "055"
COMMENT = """
UNet Baseline without negative + normalize + w/o grid distortion + post_conv3d + seq_len option(default: 7) + w/o flip, rotate + reverse_video_aug + use indivisual mask
"""
